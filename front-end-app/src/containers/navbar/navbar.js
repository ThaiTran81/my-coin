...
export const Navbar = (props) => {
    ...
    const handleBuyCoin = async () => {
        ...
        await axios.post('http://localhost:9080/transactions/buycoin', {
        ...
        <div className={`navbar row ${props.className}`}>
            <div className='navbar__container'>
                <Link to='/' className='navbar__container__logo'>
                    <img src='https://www.investopedia.com/thmb/G_PxSGLkwmmGJF-2r9Irb7uJ1cU=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/MyEtherWallet-92fe24e3a6bd44bcaf115383f637c84c.jpg' alt=''></img>
                </Link>
